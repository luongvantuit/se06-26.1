    ...
    return (
        <div>
            ...
            <div className="row row-new">
                <div className="col-12"><h1 style={{fontSize: '25px'}}>New products</h1></div>
            ...
            <div className="row row-2">
                ...
                <h5><a>Women's Plus Size Casual Hoodies Sweatshirt,Long Sleeve</a></h5>
                <p className="cost">$499.00</p>
                <h4 className="sale">$499.00</h4>
                </div>
                <div className="col-lg-2 col-md-3 col-sm-4 col-6 product product-2">
            ...
            <div className="row row-4">
                ...
                <h5><a>Lexicon Dawson 3-Piece Living Room Set, Gray</a></h5>
                <p className="cost">$499.00</p>
                <h4 className="sale">$499.00</h4>
                </div>
                <div className="col-lg-2 col-md-3 col-sm-4 col-6 product product-2">
            ...
            <div className="row row-5">
                ...
                <h5><a>Makeup Brushes, 7PCS Diamond Handle Makeup Brush Sets</a></h5>
                <p className="cost">$499.00</p>
                <h4 className="sale">$499.00</h4>
                </div>
                <div className="col-lg-2 col-md-3 col-sm-4 col-6 product product-2">
