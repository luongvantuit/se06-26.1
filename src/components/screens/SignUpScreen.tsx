                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb  mb-5 mt-4" >
                            ...
                            <li className="breadcrumb-item active" aria-current="page"><a href="#">Create Account</a></li>
                        </ol>
                    </nav>
                        ...
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <form>
                                ...
                                <div className="form-group mb-4 mt-4">
                                    <label htmlFor="exampleInputEmail1">Email or Phone number <span className="span">*</span></label>
                                    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email or Phone number"></input>
                                    
                                </div>
                                <div className="form-group mb-4 mt-4">
                                    <label htmlFor="exampleInputEmail1">Username <span className="span">*</span></label>
                                    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Name"></input>
                                    
                                </div>
                                <div className="form-group mb-4 mt-4">
                                    <label htmlFor="exampleInputPassword1">Password <span className="span">*</span></label>
                                    <input type="password" className="form-control" id="exampleInputPassword1" placeholder="Enter the Password"></input>
                                </div>
                                <div className="form-group mb-4 mt-4">
                                    <label htmlFor="exampleInputPassword1">Confirm Password <span className="span">*</span></label>
                            ...
                            <div className="container">
                                <form>
                                    <div className="container">
                                        ...
                                        <div className="gg-fb">
                                            <button className="from-button col-md-5 col-sm-5 col-5">
                                            <p className="p">Sign up with google</p>
                                            </button>
                                            <button className="from-button col-md-6 col-sm-6 col-6">
                                            {/* <img src={facebook} alt="" /> */}


                                            <p className="p"> Sign up width Facebook</p>
                                            </button>

                                        </div>
                                        <div className='form-footer'>
                                            <p>Already have an account? 
                                                <a href="#" className="acon"> Log in</a>
                                            </p>
                                        </div>
                                    </div>
