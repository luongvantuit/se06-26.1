                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb  mb-5 mt-4">
                            ...
                            <li className="breadcrumb-item active" aria-current="page"><a href="#">My Dashboard</a></li>
                        </ol>
                    </nav>
                            ...
                            <div className="container">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-5">
                                            ...
                                            <p className='alex'>You don't subscribe to our <br /> newsletter</p>
                                            <a href="#" className='edit'>Edit</a>
                                        </div>
                                    ...
                                    <div className='row'>
                                        <div className="col-6">
                                            ...
                                            <p className='alex'>You have not set a default billing <br /> address</p>
                                            <a href="#" className='edit'>Edit Address</a>
                                        </div>
                                        <div className="col-5">
                                            <p className='contact_b'>Default Shipping Address</p>
                                            <p className='alex'>You have not set a default shipping <br /> address</p>
                                            <a href="#" className='edit'>Edit Address</a>
                                        </div>
